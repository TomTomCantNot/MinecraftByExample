...
@Mod(modid = TomTomCantNot.MODID, version = TomTomCantNot.VERSION/*,
     guiFactory= TomTomCantNot.GUIFACTORY*/)  //delete guiFactory if MBE70 not present and you don't have a configuration GUI
public class TomTomCantNot
{
    public static final String MODID = "tomtomcantnot";
    public static final String VERSION = "1.0";

    // The instance of your mod that Forge uses.  Optional.
    @Mod.Instance(TomTomCantNot.MODID)
    public static TomTomCantNot instance;

    // Says where the client and server 'proxy' code is loaded.
    @SidedProxy(clientSide="tomtomcantnot.ClientOnlyProxy", serverSide="tomtomcantnot.DedicatedServerProxy")
