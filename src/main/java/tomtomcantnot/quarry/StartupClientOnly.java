...
public class StartupClientOnly
{
  ...
  public static void initClientOnly()
  {
    ...
    Item itemBlockSimple = GameRegistry.findItem("tomtomcantnot", "quarry_block");
    ModelResourceLocation itemModelResourceLocation = new ModelResourceLocation("tomtomcantnot:quarry_block", "inventory");
